...
public class RobotContainer {
    ...
    */
    private void configureButtonBindings() {
        ...
        .onTrue(m_drive.setAllWheelOffsets2());
        // setAllWheelOffsets2 just creates a command which runs the other function which returns a void and can't be called here
        // .whenActive(() -> m_drive.setAllWheelOffsets()); // Used to be whenActive()... I don't know if this fix is correct
        // // Toggle field drive
